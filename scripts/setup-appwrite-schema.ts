...
const collectionSchemas: CollectionSchema[] = [
  ...
  },
  {
    ...
    attributes: [
      ...
      { kind: 'string', key: 'textTheme', size: 32, required: false },
      ...
      { kind: 'string', key: 'infoBlocksJson', size: 50000, required: false },
      { kind: 'string', key: 'createdAt', size: 64, required: true },
      { kind: 'string', key: 'updatedAt', size: 64, required: false },
    ],
    indexes: [
  ...
  {
    id: 'event_achievements',
    name: 'Event Achievements',
    permissions: [Permission.create(Role.users()), Permission.read(Role.users())],
    documentSecurity: true,
    attributes: [
      { kind: 'string', key: 'eventId', size: 64, required: true },
      { kind: 'string', key: 'templateId', size: 64, required: false },
      { kind: 'string', key: 'scope', size: 32, required: true },
      { kind: 'string', key: 'title', size: 128, required: true },
      { kind: 'string', key: 'description', size: 1024, required: false },
      { kind: 'string', key: 'icon', size: 32, required: false },
      { kind: 'string', key: 'tone', size: 128, required: false },
      // allowed values in MVP: visible | hint | hidden
      { kind: 'string', key: 'visibility', size: 32, required: true },
      { kind: 'integer', key: 'points', required: false },
      { kind: 'string', key: 'createdBy', size: 64, required: false },
      { kind: 'string', key: 'createdAt', size: 64, required: true },
      { kind: 'string', key: 'updatedAt', size: 64, required: false },
      { kind: 'boolean', key: 'selected', required: false },
    ],
    indexes: [
      {
        key: 'eventId',
  ...
  {
    id: 'participant_achievements',
    name: 'Participant Achievements',
    permissions: [Permission.create(Role.users()), Permission.read(Role.users())],
    documentSecurity: true,
    attributes: [
      { kind: 'string', key: 'eventId', size: 64, required: true },
      { kind: 'string', key: 'achievementId', size: 64, required: true },
      { kind: 'string', key: 'participantId', size: 64, required: true },
      { kind: 'string', key: 'userId', size: 64, required: true },
      { kind: 'string', key: 'awardedByUserId', size: 64, required: true },
      { kind: 'string', key: 'awardedAt', size: 64, required: true },
    ],
    indexes: [
      {
        key: 'eventId',
      ...
      {
        key: 'achievementId_participantId',
        type: DatabasesIndexType.Unique,
        attributes: ['achievementId', 'participantId'],
        orders: ['ASC', 'ASC'],
      },
    ],
  },
  ...
  },
  {
    ...
    attributes: [
      ...
      { kind: 'string', key: 'message', size: 4096, required: false },
      { kind: 'string', key: 'createdAt', size: 64, required: true },
      { kind: 'string', key: 'updatedAt', size: 64, required: false },
    ],
    indexes: [
      ...
      {
        key: 'eventId_participantId',
        type: DatabasesIndexType.Unique,
        attributes: ['eventId', 'participantId'],
        orders: ['ASC', 'ASC'],
      },
    ],
  },
